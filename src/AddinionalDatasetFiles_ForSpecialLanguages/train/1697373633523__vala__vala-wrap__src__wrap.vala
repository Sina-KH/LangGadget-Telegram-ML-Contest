...
public class ValaBrowser : Gtk.Window {
    ...
    private const string TITLE = "Dotgrid";
    private const string DEFAULT_URL = "file:///home/derulin/Repositories/Hundredrabbits/Dotgrid/index.html";
    ...
    public ValaBrowser () {
        ...
        print("bind ");
        this.key_press_event.connect ((e, key) => {

            // To detect shift key
            stdout.printf ("state : %s / shift modifier should be : %d\n", key.str, Gdk.ModifierType.CONTROL_MASK);
    ...
    private void toggle_deco(){
      print("toggle ");
      if (get_decorated () == true) {
        set_decorated(false);
      } else {
        set_decorated(true);
      }
